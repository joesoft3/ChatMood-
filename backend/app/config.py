...
class Settings(BaseSettings):
    ...
    #   "reel"        = zero-key MoodAI Reel (FLUX scene stills → ffmpeg Ken Burns mp4)
    ...
    # 🎬 MoodAI Reel composer (ffmpeg present in both deploy images — verified)
    ...
    # in any chat and MoodAI generates inline. Zero-cost heuristic router (no LLM spent).
    ...
    # ⏰ Scheduled tasks — saved prompts MoodAI runs unattended

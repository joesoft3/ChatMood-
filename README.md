# MoodAI — a Grok-class assistant built on xAI + FastAPI + Next.js

MoodAI is a full-stack AI super-app scaffold that delivers Grok-style capabilities by

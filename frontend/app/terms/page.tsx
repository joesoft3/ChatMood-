...
export const metadata: Metadata = {
  title: "Terms of Service — MoodAI",
  description: "The agreement for using MoodAI apps, APIs and arenas.",
...
const SEC = [
  ...
  },
  {
    t: "14 · Contact",
    b: [
      "Joesoft — MoodAI (Accra). Reach us via the owner address shown in-app or the GitHub repo (joesoft3/moodai).",
    ],
  },
];
    ...
    <main className="min-h-screen bg-base text-gray-200">
      <div className="mx-auto max-w-3xl px-5 py-12">
        <p className="text-2xl font-bold">
          <span className="text-accent">✦</span> MoodAI
        </p>
        ...
        <p className="mt-6 text-[15px] leading-relaxed text-gray-300">
          These Terms are an agreement between you and the operator of MoodAI covering the apps,
